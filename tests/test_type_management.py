...
class TestTypesManagmeent(unittest.TestCase):
    def setUp(self):
        ...
        self.type_management = TypesManagement('test')
    ...
    def test_removeTypeByName(self):
        ...
        with self.assertRaisesRegex(KeyError, 'Type does not exist'):
            self.type_management.removeTypeByName('type3')
        with self.assertRaisesRegex(TypeError, 'type name should be str'):
    ...
    def test_createType(self):
        ...
        #TC2
        with self.assertRaisesRegex(KeyError, 'Type exist'):
    ...
    def test_removeObjectConnection(self):
        ...
        #TC3
        with self.assertRaisesRegex(KeyError, 'id does not exist'):
